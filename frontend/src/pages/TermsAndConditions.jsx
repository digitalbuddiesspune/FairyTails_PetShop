      ...
      <div className="bg-gradient-to-r from-[#205EA9] to-[#205EA9] py-10 md:py-14">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full mb-6">
            ...
            <span className={`text-white ${type.nav}`}>Legal Agreement</span>
          </div>
          <h1 className={`${type.hero} text-white mb-4`}>Terms & Conditions</h1>
          ...
          <main className="flex-1 max-w-7xl">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 md:p-10 space-y-10">
              ...
              <section id="acceptance">
                <h2 className={`${type.h3} text-gray-900 mb-4`}>Acceptance of Terms</h2>
              ...
              <section id="account">
                <h2 className={`${type.h3} text-gray-900 mb-4`}>Your Account</h2>
                <p className={`text-gray-600 ${type.body} mb-3`}>When you create an account with us, you agree to:</p>
              ...
              <section id="products">
                <h2 className={`${type.h3} text-gray-900 mb-4`}>Products & Pricing</h2>
                <ul className={`space-y-2 text-gray-600 ${type.body}`}>
              ...
              <section id="orders">
                <h2 className={`${type.h3} text-gray-900 mb-4`}>Orders & Payment</h2>
                <p className={`text-gray-600 ${type.body} mb-3`}>By placing an order, you agree that:</p>
                <ul className={`space-y-2 text-gray-600 ${type.body}`}>
              ...
              <section id="ip">
                <h2 className={`${type.h3} text-gray-900 mb-4`}>Intellectual Property</h2>
                <p className={`text-gray-600 ${type.body}`}>
              ...
              <section id="prohibited">
                <h2 className={`${type.h3} text-gray-900 mb-4`}>Prohibited Activities</h2>
                <p className={`text-gray-600 ${type.body} mb-3`}>You agree not to:</p>
              ...
              <section id="liability">
                <h2 className={`${type.h3} text-gray-900 mb-4`}>Limitation of Liability</h2>
                <p className={`text-gray-600 ${type.body}`}>
              ...
              <section id="indemnification">
                <h2 className={`${type.h3} text-gray-900 mb-4`}>Indemnification</h2>
                <p className={`text-gray-600 ${type.body}`}>
              ...
              <section id="governing">
                <h2 className={`${type.h3} text-gray-900 mb-4`}>Governing Law</h2>
                <p className={`text-gray-600 ${type.body}`}>
              ...
              <section id="changes">
                <h2 className={`${type.h3} text-gray-900 mb-4`}>Changes to Terms</h2>
                <p className={`text-gray-600 ${type.body}`}>
              ...
              <section id="contact">
                ...
                <div className="bg-[#205EA9]/5 border border-[#205EA9]/20 rounded-xl p-5 space-y-2">
                  <p className={`text-gray-700 ${type.body}`}><strong>FairyTails Pet Shop</strong></p>
                  ...
                  <p className={`text-gray-700 ${type.body}`}><strong>Address:</strong> Hinjewadi, Pune, Maharashtra – 411057, India</p>
                </div>
              </section>
