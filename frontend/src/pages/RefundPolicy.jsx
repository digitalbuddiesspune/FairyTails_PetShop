      ...
      <div className="bg-gradient-to-r from-[#65a30d] to-[#84cc16] py-10 md:py-14">
        <div className="container mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-white font-medium">Hassle-Free Returns</span>
          </div>
          ...
          <main className="flex-1 max-w-3xl">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 md:p-10 space-y-10">
              ...
              <section id="non-returnable">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">The following items cannot be returned or refunded:</p>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-gray-100">
                        ...
                        <th className="text-left px-5 py-3 font-semibold text-gray-700">Refund Time</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100">
                      <tr><td className="px-5 py-3 text-gray-600">UPI / Wallet</td><td className="px-5 py-3 text-gray-600">1–3 business days</td></tr>
                      <tr><td className="px-5 py-3 text-gray-600">Credit / Debit Card</td><td className="px-5 py-3 text-gray-600">5–7 business days</td></tr>
                      <tr><td className="px-5 py-3 text-gray-600">Net Banking</td><td className="px-5 py-3 text-gray-600">5–10 business days</td></tr>
                      <tr><td className="px-5 py-3 text-gray-600">Cash on Delivery</td><td className="px-5 py-3 text-gray-600">Refunded to bank account within 7–10 business days</td></tr>
                    </tbody>
                  </table>
                </div>
              </section>
